<template>
  <section class="section-two">
    <div class="section-two__text-container">
      <h2 class="section-two__text-container--title">
      ...
      <div class="divider" />
      <div class="section-two__text-container--description">
...
.section-two {
  ...
  &__image-container {
    ...
    &--texts {
      ...
      @media (min-width: 1601px) and (max-width: 1785px) {
        width: 165px;
        height: 120px;
      }
    }
