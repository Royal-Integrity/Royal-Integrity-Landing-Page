    ...
    <div class="hero-section__content">
      <div class="title-container">
        <div class="title-container__title">
          <TextHighlighter text="trapsStations.hero.title.text" keywords="trapsStations.hero.title.keywords" />
        </div>
        <div class="title-container__text">
          <TextHighlighter text="trapsStations.hero.text" keywords="trapsStations.hero.keywords" />
        </div>
      </div>
    </div>
  </section>
